...
echo "<h3> <a href='page4.php'>首页</a> 丨<a href='page4.php?p={$pageprev}'>上一页</a> |<a href='page4.php?p={$pagenext}'>下一页</a> 丨<a href='page4.php?p={$total}'>尾页</a></h3>
...
<form method="post" action="select_page.php">
