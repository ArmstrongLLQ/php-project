...
<input type="button" name="search" onclick="window.location.href='searchPage.php'" value="查询" style="float:left"> 

<form method="post" action="mainSave.php" style="float:left;">
    <input type="hidden" name="export_sql" value="<?php echo $chaxun ?>">
    <input type="submit" name="submit" value="导出">
</form>

<input type="button" name="return" onclick="window.location.href='mainPage.php'" value="返回" style="float:left"> 
<br>
...
<form action='' method='post' style="float:right"><b>总条数：<?php echo $total_row;?> | 第 <?php echo $page;?>/<?php echo $total;?> 页 | 页码：</b>
