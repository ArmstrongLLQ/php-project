...
<?php
function connectMysql($my_host, $my_username, $my_keyword, $my_database)
{
    //连接数据库
    $con = mysqli_connect($my_host, $my_username, $my_keyword, $my_database);
